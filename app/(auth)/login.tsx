                    ...
                    <AuthCard>
                        {stage === "email" && (
                            <>
                                ...
                                {/* Continue */}
                                <Button onPress={isSending ? () => {} : sendCodeSubmit} className="mt-4 h-14 rounded-full flex justify-center items-center bg-[#00A082] dark:bg-[#00A082] dark:active:bg-[#00A082]/30 transition duration-200">
                                    {isSending ? (
                        ...
                        {stage === "verifyCode" && (
                            <>
                                ...
                                {/* Continue */}
                                <Button onPress={isVerifing ? () => {} : verifyCodeSubmit} className="mt-4 h-14 rounded-full flex justify-center items-center bg-[#00A082] dark:bg-[#00A082] dark:active:bg-[#00A082]/30 transition duration-200">
                                    {isVerifing ? (
                                        <ActivityIndicator className={"text-white dark:text-[#0B0D0F]"} size={"small"}/>
                                    ) : (
                                        <Text className="text-[16px] font-nunito-bold text-white">
                                ...
                                {/* Back */}
                                <Pressable onPress={() => setStage("email")} className="mt-4 h-14 flex-row items-center justify-center rounded-full border border-neutral-200 bg-white dark:border-[#30363B] dark:bg-[#1B1F23]">
                                    <Text className="text-[16px] font-nunito-bold text-neutral-900 dark:text-[#F2F4F5]">
                                        Назад
                                    </Text>
                                </Pressable>
                        ...
                        {stage === "registration" && (
                            <>
                                ...
                                {/* Continue */}
                                <Button onPress={isRegistering ? () => {} : handleSubmit(registerSubmit)} className="mt-4 h-14 rounded-full flex justify-center items-center bg-[#00A082] dark:bg-[#00A082] dark:active:bg-[#00A082]/30 transition duration-200">
                                    {isRegistering ? (
                                        <ActivityIndicator className={"text-white dark:text-[#0B0D0F]"} size={"small"}/>
                                    ) : (
                                        <Text className="text-[16px] font-nunito-bold text-white">
                                ...
                                {/* Back */}
                                <Pressable onPress={() => setStage("email")} className="mt-2 h-14 flex-row items-center justify-center rounded-full border border-neutral-200 bg-white dark:border-[#30363B] dark:bg-[#1B1F23]">
                                    <Text className="text-[16px] font-nunito-bold text-neutral-900 dark:text-[#F2F4F5]">
                                        Назад
                                    </Text>
                                </Pressable>
